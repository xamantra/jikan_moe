...
class JikanClient {
  ...
  /// https://docs.api.jikan.moe/#tag/users/operation/getUserReviews
  Future<UsersReviewsResponse> getUserReviews(String username, {int? page}) => users.getUserReviews(this, username, page: page);
  ...
  /// https://docs.api.jikan.moe/#tag/clubs/operation/getClubMembers
  Future<ClubsMembersResponse> getClubMembers(int id, {int? page}) => clubs.getClubMembers(this, id, page: page);
