...
class MangaGenreData {
  ...
  bool operator ==(Object other) {
    ...
    return other is MangaGenreData && other.malId == malId && other.name == name && other.url == url && other.count == count;
  }
...
class MangaGenresResponse {
  ...
  factory MangaGenresResponse.fromJson(Map<String, dynamic> json) {
    return MangaGenresResponse(
      data: (json['data'] as List<dynamic>).map((item) => MangaGenreData.fromJson(item as Map<String, dynamic>)).toList(),
    );
  }
